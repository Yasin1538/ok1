...
from concurrent.futures import ThreadPoolExecutor as yaseenssb
...
logo =                                          """   
   ...
   \033[1;37m ######      ######     ########  
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           Yaseen Khan
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          Yaseen khan
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           Yaseen-Ssb
...
def yaseen():
    ...
    print(' [E] exit ')
    print('')
    _yaseen___ = input(' [?] Choose option : ')
    if _yaseen___ in ('1', '01'):
        __xxx__().yaseenx(id)
    if _yaseen___ in ('2', '02'):
        create_file()
    if _yaseen___ in ('E', 'ee'):
        pass
...
class __xxx__:
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with yaseenssb(max_workers=30) as ssbworld:
